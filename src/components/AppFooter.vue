...
export default {
	...
	data() {
		return{
			rows: [
				{
					title: "Web-mobile Project",
					children: ["Start : 2019-07-01"]
				}
			],
			gitLink: "https://lab.ssafy.com/todal/webmobile-sub2"
		};
	},
	components:{
		weather
