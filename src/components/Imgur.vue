<template>
    <div>
        <v-layout row wrap>
            ...
            <v-flex v-if="selectedRadio === 'Upload'" xs12 md12 lg12 class="text-xs-center text-sm-center text-md-center text-lg-center">
                <img :src="imageUrl" height="150" v-if="imageUrl"/>
                <v-text-field label="Click Here to Select Image" @click='pickFile' v-model='imageName' prepend-icon='attach_file' readonly></v-text-field>
                    <input
                    type="file"
                    style="display: none"
                    ref="image"
                ...
                <div class="text-xs-center" style="margin-bottom: 2.5rem;">
                    ...
                    <v-btn v-if="available" round color="pink" dark @click="addImgToAlbum">Add to Album</v-btn>
                </div>
            </v-flex>
            <v-flex v-if="selectedRadio === 'Delete'" xs12 md12 lg12 class="text-xs-center text-sm-center text-md-center text-lg-center">
                ...
                <div class="text-xs-center" style="margin-bottom: 2.5rem;" v-if="selected">
